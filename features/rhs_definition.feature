Feature: Right hand side definition
  ...
  Scenario: basic rhs definition
    ...
    module ppm_autogenerated_rhs
      ...
      implicit none
      contains
      function testrhs(fields, discretizations, changes)
        use ppm_module_interfaces
        implicit none
        real(mk), dimension(:), pointer :: dgdata
        integer :: testrhs
        type(ppm_v_field), pointer :: fields
        type(ppm_v_discr_kind), pointer :: discretizations
        type(ppm_v_field), pointer :: changes
